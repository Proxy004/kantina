  ...
  return (
    <>
      ...
      <div className="allAgb">
        ...
        <div className="contentAgb">
          <span className="contentHeadlineAgb">Einleitung und Überblick</span>
          <p>
            Wir haben diese Datenschutzerklärung (Fassung 26.05.2021-111744455)
            verfasst, um Ihnen gemäß der Vorgaben der
            Datenschutz-Grundverordnung (EU) 2016/679 und anwendbaren nationalen
            Gesetzen zu erklären, welche personenbezogenen Daten (kurz Daten)
            ...
            Die verwendeten Begriffe sind geschlechtsneutral zu verstehen. Kurz
            gesagt: Wir informieren Sie umfassend über Daten, die wir über Sie
            verarbeiten.{" "}
          </p>
          <p>
            ...
            oder andere Information dabei, die Sie noch nicht kannten. Wenn
            trotzdem Fragen bleiben, möchten wir Sie bitten, sich an die unten
          ...
          <span className="contentHeadlineAgb">Anwendungsbereich</span>
          <p>
            ...
            Datenschutzerklärung umfasst: alle Onlineauftritte (Websites,
            Onlineshops), die wir betreiben, Social Media Auftritte und
            E-Mail-Kommunikation, sowie mobile Apps für Smartphones und andere
            Geräte Kurz gesagt: Die Datenschutzerklärung gilt für alle Bereiche,
            in denen personenbezogene Daten im Unternehmen strukturiert
            verarbeitet werden.
          </p>
          <span className="contentHeadlineAgb">Rechtsgrundlagen</span>
          <p>
            ...
            folgenden Bedingungen zutrifft: Einwilligung (Artikel 6 Absatz 1
            lit. a DSGVO): Sie haben uns Ihre Einwilligung gegeben, Daten zu
            einem bestimmten Zweck zu verarbeiten. Ein Beispiel wäre die
            Speicherung Ihrer eingegebenen Daten eines Kontaktformulars. Vertrag
            ...
            personenbezogene Daten. Berechtigte Interessen (Artikel 6 Absatz 1
            ...
            Interesse. Weitere Bedingungen wie die Wahrnehmung von Aufnahmen im
            ...
            (Datenschutzgesetz), kurz DSG. In Deutschland gilt das
            Bundesdatenschutzgesetz, kurz BDSG. Sofern weitere regionale oder
